  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-ink/75">
        ...
        <h2 className="font-display pt-2 text-xl font-bold text-ink">Content & ownership</h2>
        <p>
        ...
        <h2 className="font-display pt-2 text-xl font-bold text-ink">A publish-only site</h2>
        <p>
        ...
        <h2 className="font-display pt-2 text-xl font-bold text-ink">Bookings</h2>
        <p>
        ...
        <h2 className="font-display pt-2 text-xl font-bold text-ink">External links & embeds</h2>
        <p>
        ...
        <h2 className="font-display pt-2 text-xl font-bold text-ink">Changes</h2>
        <p>
